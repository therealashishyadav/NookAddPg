...
public class PgImportRow {
	...
	// Sharing Options (JSON string)
	private String sharingOptionsJson;
	...
	public String getSharingOptionsJson() {
		return sharingOptionsJson;
	}

	public void setSharingOptionsJson(String sharingOptionsJson) {
		this.sharingOptionsJson = sharingOptionsJson;
	}
