...
public class PgListingResponse {
	...
	public void setOccupancyLabel(String occupancyLabel) {
	...
	public String getHousekeepingLabel() {
		return housekeepingLabel;
	}

	public void setHousekeepingLabel(String housekeepingLabel) {
		this.housekeepingLabel = housekeepingLabel;
	}
	...
	public List<SharingOptionResponse> getSharingOptions() {
		return sharingOptions;
	}

	public void setSharingOptions(List<SharingOptionResponse> sharingOptions) {
