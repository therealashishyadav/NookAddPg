...
public class PgListing {
	...
	private Long ownerId; // FK to users table
	...
	private OccupancyType occupancyType; // GIRLS, BOYS, COED
	...
	@Enumerated(EnumType.STRING)
	private BedType bedType; // SINGLE, DOUBLE, BUNK
	...
	private String foodOptions; // "Veg, Non-Veg, Both"
	...
	@Enumerated(EnumType.STRING)
	private HousekeepingFrequency housekeepingFrequency; // DAILY, WEEKLY, MONTHLY, NONE
	...
	private Boolean gymAvailable; // added
	private Boolean rooftopAccess; // added
	...
	private Boolean dispenserAvailable; // added

	// ── Rules & Safety ────────────────────────────────────────────────────
	private String entryExitTimings;
	private Boolean visitorsAllowed;
	private Boolean guestsOvernightAllowed; // added
	private Double securityDepositAmount;
	private Boolean idVerificationRequired;
	private Boolean fireSafetyAvailable;
	private Boolean smokingAllowed; // added
	private Boolean petsAllowed; // added
	private Boolean alcoholAllowed; // added

	// ── Pricing (base / fallback) ─────────────────────────────────────────
	// Actual per-sharing prices live in PgSharingOption
	// These are kept for quick listing-card display
	private Double depositAmount;
	private Integer noticePeriodDays;
	private Integer lockInPeriodMonths;
	private String additionalChargesInfo;
	private String maintenanceChargesInfo; // added — electricity, water etc.
	...
	@Enumerated(EnumType.STRING)
	private AvailabilityFor availabilityFor; // STUDENTS, WORKING_PROFESSIONALS, BOTH

	// ── Agreement & Policy ────────────────────────────────────────────────
	@Enumerated(EnumType.STRING)
	private AgreementType agreementType; // RENTAL, LEAVE_LICENSE, NONE
	...
	private LocalDate availableFromDate; // changed String → LocalDate (proper type)
	private Boolean waitingList;
	private Integer totalRooms; // added
	private Integer availableRooms; // added — decrements on booking

	// ── Status & Meta ─────────────────────────────────────────────────────
	private Boolean isActive = true;
	private Boolean isVerified = false; // admin-verified flag
	private Boolean isBrandNew = false;
	private Boolean isPartnerVerified = false;
	private Double rating; // avg of all reviews
	private Integer totalReviews; // added
	...
	public HousekeepingFrequency getHousekeepingFrequency() {
		return housekeepingFrequency;
	}

	public void setHousekeepingFrequency(HousekeepingFrequency housekeepingFrequency) {
	...
	public Boolean getRooftopAccess() {
	...
	public void setDispenserAvailable(Boolean dispenserAvailable) {
		this.dispenserAvailable = dispenserAvailable;
	}
	...
	public Boolean getGuestsOvernightAllowed() {
		return guestsOvernightAllowed;
	}

	public void setGuestsOvernightAllowed(Boolean guestsOvernightAllowed) {
		this.guestsOvernightAllowed = guestsOvernightAllowed;
	}
	...
	public String getMaintenanceChargesInfo() {
		return maintenanceChargesInfo;
	}

	public void setMaintenanceChargesInfo(String maintenanceChargesInfo) {
		this.maintenanceChargesInfo = maintenanceChargesInfo;
	}
	...
	public AvailabilityFor getAvailabilityFor() {
		return availabilityFor;
	}

	public void setAvailabilityFor(AvailabilityFor availabilityFor) {
	...
	public Boolean getIsPartnerVerified() {
		return isPartnerVerified;
	}

	public void setIsPartnerVerified(Boolean isPartnerVerified) {
		this.isPartnerVerified = isPartnerVerified;
	}
	...
	public List<PgSharingOption> getSharingOptions() {
		return sharingOptions;
	}

	public void setSharingOptions(List<PgSharingOption> sharingOptions) {
