...
public class PgListing {
    ...
    public void setHousekeepingFrequency(HousekeepingFrequency housekeepingFrequency) { this.housekeepingFrequency = housekeepingFrequency; }
    ...
    public List<PgSharingOption> getSharingOptions() { return sharingOptions; }
    public void setSharingOptions(List<PgSharingOption> sharingOptions) { this.sharingOptions = sharingOptions; }
}
